...
if __name__ == "__main__":
    # в этой части у нас запускает event loop
    # он подрузумевает запуск асинхроных функций и ловит 
    # когда функция должна остановится(на ключевом слове await)
    # нужно это для того, чтобы передать управление другой функции
    # после паузы возврашяется к той функции что быстрее получила ответ
    asyncio.run(main()) 